...
class OrderTable(QTableWidget):
    def __init__(self):
        ...
        self.setHorizontalHeaderLabels([
            "ID", "Client", "Courier", "Status", "Total", "Created At"
        ])
    ...
    def update_data(self, orders):
        ...
        for row, o in enumerate(orders):
            ...
            self.setItem(row, 3, QTableWidgetItem(o.getStatusString()))
            self.setItem(row, 4, QTableWidgetItem(str(o.getTotalPrice())))
            self.setItem(row, 5, QTableWidgetItem(o.getCreatedAt()))
